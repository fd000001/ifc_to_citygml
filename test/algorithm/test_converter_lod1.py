...
sys.path.insert(0, '..')
from algorithm.converter_lod1 import LoD1Converter
...
class TestConvert(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(12152, len(etree.tostring(result)))

    def test_2(self):
        root = etree.Element("root")
        lod1Conv = LoD1Converter(Converter(), ifc2, "TestABC", trans2, False)
        result = lod1Conv.convert(root)
        self.assertEqual(8972, len(etree.tostring(result)))
...
class TestConvertSolid(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertEqual(2796, len(etree.tostring(root)))
        corr = "POLYGON ((458870.063285681 5438773.62904949 110,458862.40284125 5438780.05692559 110," + \
    ...
    def test_2(self):
        ...
        self.assertIn(b"lod1Solid", etree.tostring(root))
